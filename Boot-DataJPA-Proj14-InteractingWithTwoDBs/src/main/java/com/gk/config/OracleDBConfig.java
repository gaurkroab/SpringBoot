...
@EnableJpaRepositories(basePackages = "com.gk.repository.prod",
...
public class OracleDBConfig {
	...
	@Bean(name="oracleEMF")
	@Primary
	public LocalContainerEntityManagerFactoryBean createOralceEntityManagerFactoryBean(EntityManagerFactoryBuilder builder) {
		...
		return builder.dataSource(createOracleDs())         // datasource
				                   .packages("com.gk.entity.prod")   // model class pkg
